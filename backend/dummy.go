...
func handleRequests() {
	...
	http.HandleFunc("/consumeapi", returnSearch)
...
func returnSearch(w http.ResponseWriter, r *http.Request) {

	fmt.Println("Returning the search criteria:")
...
func main() {
	...
	items = []search{
		search{ID: id, Name: name, Position: pos},
	}
